    ...
    function calculatePerformance() {
        ...
        try {
            ...
            const performanceRows = [
                ...
                [t().performanceSonarCapProgress, "sonarAbilityCapProgressPercent", (value) => `${Number(value).toFixed(1)}%`],
                [t().performanceSonarSailorRange, "sonarSailorRangePercent", (value) => `${Number(value).toFixed(1)}%`],
